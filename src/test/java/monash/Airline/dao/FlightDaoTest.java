...
public class FlightDaoTest {
    ...
    public void testGetFlightsByDepartTo() {
        FlightDao flightDao = new FlightDao();
        String departTo = "Destination"; // 根据需要设置要查询的目的地
    ...
    public void testGetFlightsByDepartFromAndDepartTo() {
        FlightDao flightDao = new FlightDao();
        String departFrom = "Origin"; // 根据需要设置要查询的起始地
        String departTo = "Destination"; // 根据需要设置要查询的目的地
    ...
    public void testAddFlight() {
        ...
        // 查询添加的航班是否存在
        Flight addedFlight = flightDao.getFlightByID(flight.getFlightID());
    ...
    public void testUpdateFlight() {
        ...
        // 创建一个Flight对象并设置相应的属性
        Flight flight = new Flight();
        flight.setFlightID(1); // 根据需要设置要更新的航班ID
